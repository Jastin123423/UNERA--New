        ...
        >
          <div className="relative flex items-center justify-center">
            ...
            {Number(badgeCounts?.home || 0) > 0 && (
              <span className="absolute -top-1 -right-2 w-2 h-2 rounded-full bg-[#1877F2]" />
            )}
          </div>
          <span
        ...
        >
          <div className="relative flex items-center justify-center">
            ...
            {Number(badgeCounts?.marketplace || 0) > 0 && (
              <span className="absolute -top-1.5 -right-3 bg-[#1877F2] text-white text-[10px] font-bold px-1.5 py-[0.5px] rounded-full min-w-[17px] text-center shadow-sm">
    ...
    <>
      ...
      <header className="sticky top-0 z-50 bg-[#0B1120]/98 backdrop-blur-xl border-b border-[#1E293B] pt-[env(safe-area-inset-top,0px)]">
        <div className="h-14 px-3 sm:px-4 flex items-center justify-between gap-2 max-w-7xl mx-auto">
          ...
          {/* RIGHT: Search, Video, Music, Notifications, Profile / Login */}
          <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
            ...
            <button
              ...
              className={`w-9 h-9 sm:w-10 sm:h-10 rounded-xl border transition-colors flex items-center justify-center focus:outline-none ${
                activeTab === 'reels'
                  ? 'bg-[#1E293B] border-[#1877F2] text-[#1877F2]'
                  : 'bg-[#0F172A] hover:bg-[#1E293B] border-[#1E293B] text-[#94A3B8] hover:text-[#F8FAFC]'
              }`}
              aria-label="Reels and Video"
              title="Video"
            >
              <i className="fas fa-video text-[15px]"></i>
            </button>
            ...
            <button
              ...
              aria-label="UNERA Music"
              title="Music"
            >
              <i className="fas fa-music text-[15px]"></i>
            </button>
            ...
            >
              ...
              {unreadCount > 0 && (
                <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 bg-[#1877F2] text-white text-[10px] font-bold rounded-full flex items-center justify-center shadow-sm ring-2 ring-[#0B1120]">
      ...
      {showSearchOverlay && (
        <div className="fixed inset-0 z-[180] bg-black/70 backdrop-blur-sm animate-fade-in">
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <div className="relative flex-1">
                ...
                <input
                  autoFocus
                  type="text"
                  placeholder="Search profiles on UNERA..."
                  value={searchQuery}
            ...
            <div className="mt-2.5 text-xs text-[#94A3B8] px-2">
              {searchQuery.trim()
            ...
            {searchQuery.trim() && (
              <div className="mt-3 bg-[#0F172A] rounded-2xl border border-[#1E293B] overflow-hidden max-h-[60vh] overflow-y-auto divide-y divide-[#1E293B]">
                {searchResults.length > 0 ? (
                  ...
                  <div className="p-6 text-center text-[#94A3B8] text-sm">No profiles found</div>
                )}
              </div>
            )}
          </div>
