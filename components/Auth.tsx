...
export const Login: React.FC<LoginProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#18191A] flex flex-col justify-between p-4 relative animate-fade-in">
      <div
        className="absolute top-4 right-4 w-10 h-10 bg-[#3A3B3C] rounded-full flex items-center justify-center cursor-pointer hover:bg-[#4E4F50] transition-colors z-50"
        onClick={onClose}
      ...
      <div className="mt-8 text-center text-xs text-[#B0B3B8]">
        <p>
          ...
          <span className="text-[#E4E6EB] font-bold cursor-pointer hover:underline" onClick={onClose}>
            Continue as Guest
          </span>{' '}
          to view.
        </p>
